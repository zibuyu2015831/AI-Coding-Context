...
| 优化点           | 配置项示例              | 说明                                 |
| ---------------- | ----------------------- | ------------------------------------ |
| 013-AI 互审      | `enableMutualReview`    | 是否启用 AI 互审机制                 |
...
| 001-AI 角色库    | `preferredRoles`        | 优先使用的 AI 角色列表               |
...
### 联动设计: 智能系统追踪器 (System Tracker)

> **详情请见**: [016.5-system-tracker.md](./016.5-system-tracker.md)

**概述**:
利用配置系统的存储能力，建立运行时状态文件，用于记录高频操作，驱动工具沉淀。此功能已独立为扩展点 016.5 进行详细设计。
