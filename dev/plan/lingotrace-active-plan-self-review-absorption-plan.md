...
| framework_spec plans/ 指针 + done 硬规则 | `pre_commit_gate.py` 扩展 + `doc_health.py` 检查 | `.codex/` 包内 `pre_commit_gate` **hook 强制** + `AGENTS.md` 顾问兜底 |
