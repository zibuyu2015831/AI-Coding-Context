...
- [LingoTrace 方案自审核协议吸收分析与决策记录](./lingotrace-active-plan-self-review-absorption-plan.md) — `proposed`（§11 开放问题已定案 + §7.6 插件/Codex 落地映射已设计；Codex hook 前提已更正、通用强制包已落地，待转可执行实施计划）
