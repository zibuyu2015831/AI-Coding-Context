...
> **新增 (v3.0)**: 框架现在有系统化的质量保证体系

如果你要为框架本身新增或修改文档（如新的 workflow、guide 等），请遵循以下规范：

### 新增框架文档

当你为框架新增一个文档时（例如新的工作流`workflows/new_workflow.md`）:

**步骤 1: 编写文档**

- 遵循现有文档的格式和风格
- 参考 `quality/standards/COMMON_STANDARDS.md` 中的质量标准
- 确保文档包含所有必需章节
...
```
【方式A: AI辅助生成（推荐）】
1. 阅读 quality/HOW_TO_GENERATE_CONTEXTS.md
2. 请求AI: "请为 [新文档路径] 生成审查上下文"
3. AI会自动执行"单个新文档上下文生成工作流"
4. 人工审核生成的上下文

【方式B: 手动创建】
1. 复制 quality/contexts/_template.md
2. 基于新文档内容填充模板
3. 保存到 quality/contexts/[对应文件名].md
```

**步骤 3: 更新索引**

在 `quality/README.md` 中添加新文档的索引条目:
...
使用 `quality/standards/QUALITY_CHECKLIST.md` 进行自检:
...
1. 修改文档
2. **更新对应的审查上下文**（`quality/contexts/`）
   - 更新核心职责
   - 更新必须包含的内容
   - 更新检查要点
3. 更新审查上下文中的"最后更新"日期

**轻微修改**（修正错别字、更新示例、小幅调整）:
...
- 通用标准: `quality/standards/COMMON_STANDARDS.md`
- 分类标准: `quality/standards/BY_DOCUMENT_TYPE.md`
- 快速检查: `quality/standards/QUALITY_CHECKLIST.md`

**审查工作流**:

- 完整流程: `quality/AUDIT_WORKFLOW.md`
- 批量生成: `quality/HOW_TO_GENERATE_CONTEXTS.md`
...
quality/
├── README.md                   # 从这里开始了解
├── AUDIT_WORKFLOW.md           # 审查流程
├── HOW_TO_GENERATE_CONTEXTS.md # 生成审查上下文指南
├── standards/                  # 质量标准
├── contexts/                   # 审查上下文
└── reports/                    # 审查报告
```
...
- [ ] 文档内容完整，遵循质量标准
- [ ] 已生成对应的审查上下文
- [ ] 已更新 `quality/README.md` 索引
- [ ] 已对照质量检查清单自检
- [ ] （如适用）已更新 `AI_ENTRY_POINT.md` 索引
