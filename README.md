...
而在生成式 AI 普及的今天，这个问题变得更加严峻。"Vibe Coding"（凭感觉编程）成为主流开发模式，开发者习惯于抛出一个模糊的需求，让 AI 快速生成代码。这种模式虽然提速明显，但却在**加速熵增**的过程。

#### 新项目的快速膨胀

你一定**有过**这种感受：在项目初期，AI 能极大提升效率，但随着项目推进，堆积的复杂度会达到一个难以承受的地步。
...
而对于已有的成熟项目，问题同样棘手：进行新功能开发或 bug 修复时，AI 因为缺少项目上下文，往往显得力不从心，反而可能引入新的问题。

#### Vibe Coding 的本质：技术高利贷
...
- **Document Priority** - 文档优先，鼓励 AI 生成结构化文档，鼓励开发者持续阅读、审核以掌控项目全局
...
- **危险指令拦截**: 识别并阻止可能导致技术债的"快餐式"指令。
- **AI 互审机制**: 引入独立的"审查员"角色，对生成的代码进行对抗性审查。
