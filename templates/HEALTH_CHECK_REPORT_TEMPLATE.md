...
另外，首版生成完成后可直接复用本模板中的“首版交付验收版”输出标准化报告。
...
- `generation_plan.md`: PASS / FAIL
- `generation_progress.md`: PASS / FAIL
- 发现问题数: X
...
- 语义复查命令: `semantic_review_checker --full-check --doc-dir dev_docs --repo-root .`
- 量化声明复核: [已执行 / 未执行]
- 测试资产扫描摘要: [如适用]
- 主要偏差: [如无则写“无”]
